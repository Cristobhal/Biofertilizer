...
parallel_assign_taxonomy_blast.py -i biofert.screened.fna -o taxonomy -r 97_otus_16S.fasta -t consensus_taxonomy_7_levels.txt
...
sed -i 's/Candidatus /Candidatus_/g' biofert.biom.tsv
sed -i 's/[//g' biofert.biom.tsv
sed -i 's/]//g' biofert.biom.tsv
sed -i 's/ /_/g' biofert.biom.tsv
sed -i 's/(//g' biofert.biom.tsv
sed -i 's/)//g' biofert.biom.tsv
sed -i 's/#//g' biofert.biom.tsv
```
...
```R
#Edit biom file 
sed -i 's/D_0__//g' biofert.biom.tsv
sed -i 's/D_1__//g' biofert.biom.tsv
sed -i 's/D_2__//g' biofert.biom.tsv
sed -i 's/D_3__//g' biofert.biom.tsv
sed -i 's/D_4__//g' biofert.biom.tsv
sed -i 's/D_5__//g' biofert.biom.tsv
sed -i 's/D_6__//g' biofert.biom.tsv
```


```R
#Split taxonomy table from OTU table.
perl -pe 's/\; /\;/g' biofert.biom.tsv | awk '{print $1,"\t",$NF}' | perl -pe 's/\;_/\t/g' > biofert_16S_tax.tsv
sed -i -e "1,2d" biofert_16S_tax.tsv
